 ...
 * @since 16.11
 */
class OnOffStatusDataPointFactory implements DataPointFactory {
	...
	@Override
	@Nonnull
	public final DataPoint create(@Nonnull final DataPointConfiguration configuration, @Nonnull final String propertyTypeIdentifier,
